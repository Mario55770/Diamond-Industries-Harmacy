// RimWorld.Pawn_DrugPolicyTracker
...
{
	public class Pawn_PoisonPolicyTracker : IExposable
	{
		public Pawn pawn;

		private PoisonPolicy curPolicy;
		...
		public PoisonPolicy CurrentPolicy
		{
			get
			{
				if (curPolicy == null)
				{
					curPolicy = StaticPoisonDatabase.poisonPolicyDatabase.DefaultDrugPolicy();
				}
				return curPolicy;
			}
			set
		...
		public Pawn_PoisonPolicyTracker()
		{
		}

		public Pawn_PoisonPolicyTracker(Pawn pawn)
		{
			this.pawn = pawn;
		}
		...
		public bool AllowedToTakeToInventory(ThingDef thingDef)
		{
			...
			PoisonPolicyEntry drugPolicyEntry = CurrentPolicy[thingDef];
		...
		public bool ShouldTryToTakeScheduledNow(ThingDef ingestible)
		{
			...
			PoisonPolicyEntry drugPolicyEntry = CurrentPolicy[ingestible];
			if (drugPolicyEntry.daysFrequency < 1f)
			{
