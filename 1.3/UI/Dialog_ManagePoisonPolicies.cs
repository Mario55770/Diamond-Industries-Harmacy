// RimWorld.Dialog_ManageDrugPolicies
...
namespace DI_Harmacy
{
	...
	public class Dialog_ManagePoisonPolicies : Window
	{
		private Vector2 scrollPosition;

		private PoisonPolicy selPolicy;
		...
		private PoisonPolicy SelectedPolicy
		{
			get
			{
				return selPolicy;
		...
		public Dialog_ManagePoisonPolicies(PoisonPolicy selectedAssignedDrugs)
		{
			forcePause = true;
			doCloseX = true;
			doCloseButton = true;
