...
namespace DI_Harmacy
{
	...
	public class Pawn_PoisonPolicyTracker : IExposable
	{
		...
		private RimWorld.DrugPolicy curPolicy;
		...
		public RimWorld.DrugPolicy CurrentPolicy
		{
			get
			{
				if (curPolicy == null)
		...
		public bool AllowedToTakeToInventory(ThingDef thingDef)
		{
            ...
            RimWorld.DrugPolicyEntry drugPolicyEntry = CurrentPolicy[thingDef];
		...
		public bool ShouldTryToTakeScheduledNow(ThingDef ingestible)
		{
            ...
            RimWorld.DrugPolicyEntry drugPolicyEntry = CurrentPolicy[ingestible];
			if (drugPolicyEntry.daysFrequency < 1f)
			{
